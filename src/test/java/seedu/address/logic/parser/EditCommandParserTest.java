...
public class EditCommandParserTest {
    ...
    private static final String OPENING_HOURS_DESC = " " + PREFIX_OPENING_HOURS + "0900 - 1800";
    ...
    @Test
    public void parse_tagsProvided_failure() {
        // edit must not accept tags anymore
        String userInput = "1 " + PREFIX_TAG + "friend";
        assertParseFailure(parser, userInput, EditCommand.MESSAGE_TAG_NOT_ALLOWED);
    }
    ...
    @Test
    public void parse_openingHoursOnly_success() {
        Index targetIndex = INDEX_FIRST_PERSON;
        String userInput = targetIndex.getOneBased() + OPENING_HOURS_DESC;
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        // valid followed by invalid -> duplicates detected
        String userInput = targetIndex.getOneBased() + INVALID_PHONE_DESC + PHONE_DESC_BOB;
        assertParseFailure(parser, userInput, Messages.getErrorMessageForDuplicatePrefixes(
                CliSyntax.PREFIX_PHONE));

        // multiple valid fields repeated (including opening hours)
        userInput = targetIndex.getOneBased()
                + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY + OPENING_HOURS_DESC
                + PHONE_DESC_BOB + ADDRESS_DESC_BOB + EMAIL_DESC_BOB + OPENING_HOURS_DESC_2;

        assertParseFailure(parser, userInput, Messages.getErrorMessageForDuplicatePrefixes(
                CliSyntax.PREFIX_PHONE,
                CliSyntax.PREFIX_EMAIL,
                CliSyntax.PREFIX_ADDRESS,
                PREFIX_OPENING_HOURS));
    }
}
